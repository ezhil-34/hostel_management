/**
 * CORS policy for the maintenance service, shared in shape (not in code) with
 * the core API. Copied rather than imported, like the rest of this service's
 * infrastructure, so it stays independently deployable.
 *
